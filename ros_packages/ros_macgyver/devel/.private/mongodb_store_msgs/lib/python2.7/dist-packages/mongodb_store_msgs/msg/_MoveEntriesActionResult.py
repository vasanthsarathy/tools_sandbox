...
"""autogenerated by genpy from mongodb_store_msgs/MoveEntriesActionResult.msg. Do not edit."""
import sys
...
class MoveEntriesActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "mongodb_store_msgs/MoveEntriesActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mongodb_store_msgs/MoveEntriesResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveEntriesActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = mongodb_store_msgs.msg.MoveEntriesResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = mongodb_store_msgs.msg.MoveEntriesResult()
