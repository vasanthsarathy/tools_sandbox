...
"""autogenerated by genpy from mongodb_store_msgs/MoveEntriesActionFeedback.msg. Do not edit."""
import sys
...
class MoveEntriesActionFeedback(genpy.Message):
  _md5sum = "6dafd6ecae79e05a072ce163776da775"
  _type = "mongodb_store_msgs/MoveEntriesActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','mongodb_store_msgs/MoveEntriesFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveEntriesActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = mongodb_store_msgs.msg.MoveEntriesFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = mongodb_store_msgs.msg.MoveEntriesFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.feedback.completed)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.completed:
        length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.feedback.completed.append(val1)
      return self
