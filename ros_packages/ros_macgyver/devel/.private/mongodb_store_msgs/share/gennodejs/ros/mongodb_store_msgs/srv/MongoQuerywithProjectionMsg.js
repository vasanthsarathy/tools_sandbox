...
class MongoQuerywithProjectionMsgRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MongoQuerywithProjectionMsgRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MongoQuerywithProjectionMsgRequest
    let len;
    let data = new MongoQuerywithProjectionMsgRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MongoQuerywithProjectionMsgRequest(null);
...
MongoQuerywithProjectionMsgRequest.Constants = {
  JSON_QUERY: '"jnsdfskajd_fmgs.dlf"',
}

class MongoQuerywithProjectionMsgResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.messages = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MongoQuerywithProjectionMsgResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MongoQuerywithProjectionMsgResponse
    let len;
    let data = new MongoQuerywithProjectionMsgResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MongoQuerywithProjectionMsgResponse(null);
...
module.exports = {
  Request: MongoQuerywithProjectionMsgRequest,
  Response: MongoQuerywithProjectionMsgResponse,
  md5sum() { return '45d9c9b353113ab0888f363d63903883'; },
  datatype() { return 'mongodb_store_msgs/MongoQuerywithProjectionMsg'; }
};
