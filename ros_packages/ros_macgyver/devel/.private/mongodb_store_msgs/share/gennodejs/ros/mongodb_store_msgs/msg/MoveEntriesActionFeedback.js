...
class MoveEntriesActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MoveEntriesFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveEntriesFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveEntriesActionFeedback(null);
    ...
    data.feedback = MoveEntriesFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveEntriesFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveEntriesActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveEntriesFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveEntriesFeedback()
    }
...
module.exports = MoveEntriesActionFeedback;
